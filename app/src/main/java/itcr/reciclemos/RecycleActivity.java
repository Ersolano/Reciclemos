...
public class RecycleActivity extends GameActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trashHost.addTab(trashSpec);
        // Tab 7 - Orange
        trashSpec = trashHost.newTabSpec("Orange");
        trashSpec.setContent(R.id.orange_Layout);
        trashSpec.setIndicator("", ResourcesCompat.getDrawable(getResources(), R.drawable.btn_recycle_menu_orange, null));
        trashList = (ListView)findViewById(R.id.orange_ListView);
        trashAdapter = new CustomListAdapter(this, toolBox.STRING_ORANGE_ALL_DESC, toolBox.INTEGER_ORANGE_ALL_DRAWABLE);
        trashList.setAdapter(trashAdapter);
        trashHost.addTab(trashSpec);
        //Tab 8 - Purple
        ...
        for (int i = 0; i < trashHost.getTabWidget().getChildCount(); i++){
            trashHost.getTabWidget().getChildAt(i).getLayoutParams().height = (int)(currentScreenSize.y * 0.20);
        }
    }
