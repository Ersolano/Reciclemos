...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "app_start");
    ...
    public void showAbout(View view){
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "showAbout");
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "AboutMenu");
        bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "open_aboout");
        mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_CONTENT, bundle);
    ...
    public void showForest(View view){
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "showForest");
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "ForestLevel");
        bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "play_forest_level");
    ...
    public void showHouse(View view){
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "showHouse");
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "HouseLevel");
        bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "play_house_level");
        Intent startForest = new Intent(this, ForestActivity.class);
    ...
    public void showLake(View view){
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "showLake");
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "LakeLevel");
        bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "play_lake_level");
    ...
    public void showRecycle(View view){
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "showRecycle");
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "RecycleMenu");
        bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "open_recycle");
